          ...
          if (formVal != null && typeof formVal !== 'undefined') {
            switch (field) {
              ...
              case 'quad':
                ...
                break;
              case 'storeVolumes':
                // inserting storeVolumes is a separate process from updating the store and the app has to make sure
                // the store exists first set up a listener for the completion event, THEN add the volume
